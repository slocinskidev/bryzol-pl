		...
		>
			...
			>
				...
				<div
					...
					className={`absolute top-0 left-0 hidden origin-top-left dark:block`}
				/>
				<div
					style={{
						transform: 'rotate(-45deg) translate(5%, -50%)',
					...
					className={`absolute top-0 left-0 block origin-top-left dark:hidden`}
				/>
				<div
					style={{
			...
			>
				...
				<div
					...
					className={`absolute top-0 right-0 hidden origin-top-right dark:block`}
				/>
				<div
					style={{
						transform: 'rotate(45deg) translate(-5%, -50%)',
					...
					className={`absolute top-0 right-0 block origin-top-right dark:hidden`}
				/>
				<div
					style={{
						transform: 'rotate(45deg) translate(180%, -70%)',
